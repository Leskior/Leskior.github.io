...
export function getStandardBoneDefinitions() {
    return standardBoneDefinitions;
}
export function detectStandardBones(bones) {
    ...
    const semiStandardPresent = [];
    const semiStandardMissing = [];
...
function matchBone(entry, nameIndex, englishNameIndex) {
