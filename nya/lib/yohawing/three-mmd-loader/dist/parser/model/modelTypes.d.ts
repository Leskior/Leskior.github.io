...
export type DiagnosticCategory = "material" | "morph" | "skeleton" | "physics" | "texture" | "accessory" | "project" | "core";
...
export interface MorphData {
    name: string;
    englishName: string;
    type: "base" | "group" | "vertex" | "bone" | "uv" | "additionalUv" | "material" | "flip" | "impulse" | "unknown";
    vertexOffsets: Array<{
        vertexIndex: number;
        position: [number, number, number];
    }>;
...
export interface JointData {
    name: string;
    englishName: string;
    type: "generic6dofSpring" | "generic6dof" | "point2point" | "coneTwist" | "slider" | "hinge" | "unknown";
...
export interface SoftBodyData {
    ...
    aeroModel: "vertexPoint" | "vertexTwoSided" | "vertexOneSided" | "faceTwoSided" | "faceOneSided" | "unknown";
    config: {
