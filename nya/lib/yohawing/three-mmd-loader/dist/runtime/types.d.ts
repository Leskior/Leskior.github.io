...
export interface MmdRuntime {
    setAnimation(animation: import("../parser/model/modelTypes.js").MmdAnimation, mesh: import("three").SkinnedMesh): void;
    /**
     ...
     */
    tick(seconds: number, mesh: import("three").Object3D | null | undefined, options?: MmdRuntimeEvaluateOptions): MmdFrameState;
    /**
...
export type RuntimeMorph = Pick<import("../parser/model/modelTypes.js").MorphData, "type" | "groupOffsets" | "flipOffsets"> & {
