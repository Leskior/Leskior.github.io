import { createMmdRuntimePoseBuffer } from "./protocol.js";
export class MmdRuntimeTransferablePosePool {
    capacity;
    boneValueCount;
    morphCount;
    available;
    constructor(boneCount, morphCount, capacity = 3) {
        ...
        this.available = new Array(capacity);
    ...
    release(pose) {
        ...
        for (let index = 0; index < this.available.length; index += 1) {
            ...
            if (availablePose?.worldMatricesColumnMajor.buffer === pose.worldMatricesColumnMajor.buffer &&
