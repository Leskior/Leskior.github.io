...
export function parseLoaderMmdModelData(bytes) {
...
export function createLoaderMmdModelDataFromModel(model) {
...
function createThreeMmdSkeletonData(skeleton) {
    return {
        bones: skeleton.bones.map(createThreeMmdSkeletonBone)
    };
}
function createThreeMmdSkeletonBone(bone) {
    return {
        name: bone.name,
